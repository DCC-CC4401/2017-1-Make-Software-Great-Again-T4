...
def index(request):
    ...
    return render(request, 'app/baseAlumno-sinLogin.html', {"vendedores": vendedoresJson})
...
def fijoDashboard(request):
    ...
    return render(request, 'app/fijoDashboard.html',
...
def ambulanteDashboard(request):
    ...
    return render(request, 'app/ambulanteDashboard.html',
                  {"transacciones": transaccionesDiariasArr, "ganancias": gananciasDiariasArr,
                   "productos": productosArr, "productosHoy": productosHoyArr, "productosPrecio": productosPrecioArr})
...
def adminEdit(request):
    ...
    print(avatar)
    return render(request, 'app/adminEdit.html',
...
def adminPOST(id, avatar, email, nombre, contraseña, request):
    ...
    return render(request, 'app/baseAdmin.html', argumentos)
        ...
        for p in Usuario.objects.raw('SELECT * FROM usuario'):
            if p.contraseña == password and p.email == email:
                ...
                if tipo == 0:
                    ...
                    url = 'app/vendedor-ambulante.html'
                    id = p.id
                    tipo = p.tipo
                    encontrado = True
                    avatar = p.avatar
...
def gestionproductos(request):
    if request.session.has_key('id'):
        ...
        if tipo == 3:
            path = "app/baseVAmbulante.html"
        if tipo == 2:
            path = "app/baseVFijo.html"
    return render(request, 'app/agregar-productos.html', {"path": path})
    ...
    if request.method == "POST":
        if request.session.has_key('id'):
            ...
            if Formulario.is_valid():
                ...
                return render(request, 'app/agregar-productos.html',
    ...
    if request.method == 'POST':
        ...
        for p in Usuario.objects.raw('SELECT * FROM usuario'):
            if p.id == id:
                ...
                horarioFin = p.horarioFin
                if tipo == 3:
                    url = 'app/vendedor-ambulante-vistaAlumno.html'
                    break
                if tipo == 2:
                    url = 'app/vendedor-fijo-vistaAlumno.html'
                    break
    # obtener alimentos
    i = 0
    listaDeProductos = []
    ...
    if request.method == 'POST':
        ...
        for p in Usuario.objects.raw('SELECT * FROM usuario'):
            if p.id == id:
                ...
                activo = p.activo
                if tipo == 3:
                    url = 'app/vendedor-ambulante-vistaAlumno-sinLogin.html'
                    break
                if tipo == 2:
                    url = 'app/vendedor-fijo-vistaAlumno-sinLogin.html'
                    break
                    # obtener alimentos
    i = 0
    listaDeProductos = []
...
def inicioAlumno(request):
    ...
    for p in Usuario.objects.raw('SELECT * FROM usuario'):
        ...
        if p.tipo == 2 or p.tipo == 3:
            vendedores.append(p.id)
    vendedoresJson = simplejson.dumps(vendedores)
    return render(request, 'app/baseAlumno.html', {"id": id, "vendedores": vendedoresJson, "avatarSesion": avatar,
...
def cambiarFavorito(request):
    if request.method == "GET":
        if request.is_ajax():
            ...
            # return render_to_response('app/baseAdmin.html', {'form':form,'test':test},
...
def editarPerfilAlumno(request):
    ...
    return render(request, 'app/editar-perfil-alumno.html',
